...
target "default" {
  ...
  args = {
    ...
    CARTESI_ROLLUPS_NODE_BASE_IMAGE   = "docker.io/library/debian:bookworm-20250317-slim"
    CARTESI_ROLLUPS_NODE_VERSION      = "2.0.0-alpha.1"
    CARTESI_SDK_BASE_IMAGE            = "docker.io/library/debian:bookworm-20250317-slim"
    CRANE_VERSION                     = "0.19.1"
    ESPRESSO_DEV_NODE_BASE_IMAGE      = "ghcr.io/espressosystems/espresso-sequencer/espresso-dev-node:20241120-patch6"
    FOUNDRY_VERSION                   = "0.3.0"
    GO_MIGRATE_VERSION                = "4.18.2"
    POSTGRES_BASE_IMAGE               = "docker.io/library/postgres:16"
    SU_EXEC_VERSION                   = "0.2"
